...
replace all instances of ``frontend-app-base-test`` with the name of
...
This section concerns development of ``frontend-app-base-test`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-base-test/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-base-test/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-base-test
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-base-test.svg
    :target: https://github.com/openedx/frontend-app-base-test/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-base-test/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-base-test/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-base-test/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-base-test?branch=main
    :alt: Codecov
